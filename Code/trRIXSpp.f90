...
10 format('_Cu',i1,'O',i1,'_Ipp_Spump_Amp',f5.3,'_winm',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')
11 format('_Cu',i1,'O',i1,'_Ipp_Spump_Amp',f5.3,'_win',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')
12 format('_Cu',i1,'O',i1,'_Ipp_Spump_Amp',f5.2,'_winm',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')
13 format('_Cu',i1,'O',i1,'_Ipp_Spump_Amp',f5.2,'_win',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')
14 format('_Cu',i1,'O',i2,'_Ipp_Spump_Amp',f5.3,'_winm',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')
15 format('_Cu',i1,'O',i2,'_Ipp_Spump_Amp',f5.3,'_win',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')
16 format('_Cu',i1,'O',i2,'_Ipp_Spump_Amp',f5.2,'_winm',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')
17 format('_Cu',i1,'O',i2,'_Ipp_Spump_Amp',f5.2,'_win',f5.3,'_geq',f5.3,'_gam',f5.3,'_',i3.3,'.dat')

!define the DME
DME_yin = 0.0d0
DME_xin = cos(45.0d0*pi/180.0d0)
DME_yout = 0.0d0
DME_xout = cos(45.0d0*pi/180.0d0)
...
close(unit=nfwrk1)
open(unit=666,file='zrs_intensity_vs_t_ppol.dat',action='write',status='replace')
close(unit=666)
...
do nt = 1,numtime-1,ntskip
 ...
 open(unit=666,file='zrs_intensity_vs_t_ppol.dat',access='append')
 write(unit=666,fmt="(5(f12.6,' '))") time*0.001d0, displacement, SiSip1tmp, integral/I0, temp
 close(unit=666)
 write(unit=6  ,fmt="(5(f12.6,' '))") time*0.001d0, displacement, SiSip1tmp, integral/I0, temp
